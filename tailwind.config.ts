  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom attribution platform colors
        cosmic: {
      ...
      backgroundImage: {
        "cosmic-gradient":
          "linear-gradient(135deg, hsl(var(--cosmic-primary)), hsl(var(--cosmic-secondary)), hsl(var(--cosmic-accent)))",
        "neural-pattern":
          "radial-gradient(circle at 50% 50%, hsl(var(--neural-glow) / 0.1) 0%, transparent 50%)",
      },
      keyframes: {
        "accordion-down": {
          from: {
